...
/**
 * Created by hgx on 2015/8/19.
 */
public class DeletableEditText extends EditText {
    private Drawable mRightDrawable;
    private static final int SHAKE_DURING =700;
    ...
    public void startShakeAnimation() {
        this.startAnimation(startShakeAnimation(4));
     ...
     * @return
     */
    public Animation startShakeAnimation(int CycleTimes) {
        Animation translateAnimation = new TranslateAnimation(0, 10, 0, 0);
        translateAnimation.setInterpolator(new CycleInterpolator(CycleTimes));
        translateAnimation.setDuration(SHAKE_DURING);
